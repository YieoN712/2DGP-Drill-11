...
class Boy:
    ...
    def draw(self):
        ...
        if self.state_machine.cur_state == Idle: draw_rectangle(*self.get_bb())
        elif self.state_machine.cur_state == Sleep: draw_rectangle(*self.get_bb())
        elif self.state_machine.cur_state == Run: draw_rectangle(*self.get_bb())
    ...
    def get_bb(self):
        if self.state_machine.cur_state == Idle:
            ...
            return self.x - 75, self.y - 40, self.x + 10, self.y
        elif self.state_machine.cur_state == Sleep and self.face_dir == -1:
            return self.x - 10, self.y - 40, self.x + 75, self.y
